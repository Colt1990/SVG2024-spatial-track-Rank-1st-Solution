...
--video_size 20,3,64,64 --audio_size 2,8000 --learn_sigma False --num_channels 128 
--num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 True
--use_scale_shift_norm True --video_fps 4 --audio_fps 16000"
...
MULTIMODAL_MODEL_PATH="/data/stan_2024/20_2024_sony/svg-2024-spatial-track-starter-kit-master/models/pretrained_models/model330011.pt"
SR_MODEL_PATH="/data/stan_2024/20_2024_sony/MM-Diffusion/sr-image-train/model120000.pt"
OUT_DIR="/data/stan_2024/20_2024_sony/MM-Diffusion/test_output"
REF_PATH="/data/stan_2024/20_2024_sony/SVG2024-spatial-track-v0/video_dev"
